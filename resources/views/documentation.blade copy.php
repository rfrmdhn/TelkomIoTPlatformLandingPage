...
<section style="z-index: 20;"></section>
        ...
        <section style="">
            ...
            <div class="row">
                <div class="tab">
                    ...
                    <button class="tablinks" onclick="openCity(event, '1')" id="defaultOpen">1. What is Telkom IoT Platform?</button>
                    <button class="tablinks" onclick="openCity(event, '2')">2. What is the benefit of Telkom IoT Platform?</button>
                    <button class="tablinks" onclick="openCity(event, '3')">3. Architecture of Telkom IoT Platform</button>
                    <button class="" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" onclick="openCity(event, '4')">
                        4. How To Register Your Account 
                    </button>
                    
                    <div class="collapse child-0 card-0" id="collapseExample">
                            <a class=" child-0" onclick="window.location.href='#41';" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample">
                                4.1 Step 1 : Input fields in Registration Form
                            </a>
                            <div class="collapse child-1 card-0" id="collapseExample1">
                                <a class="" type="button" href="#411">
                                    4.1.1 Regular Account 
                                </a>
                                <a class="" type="button" href="#412">
                                    4.1.2 B2B Research & Innovation Collaboration
                                </a>
                            </div>
                            <button class=" child-0" type="button" onclick="window.location.href='#42';">
                                4.2 Step 2 : Verification Email Address
                            </button>
                            <button class=" child-0" type="button" onclick="window.location.href='#43';">
                                4.3 Step 3 : Check Email Inbox
                            </button>
                            <button class=" child-0" type="button" onclick="window.location.href='#44';">
                                4.4 Step 4 : Account Ready To Use
                            </button>
                    </div>
                    <button class="tablinks" onclick="openCity(event, '5')">5. Sign In</button>
                    <button class="tablinks" onclick="openCity(event, '6')">6. Account Dashboard</button>
                    <button class="" type="button" data-bs-toggle="collapse" data-bs-target="#Collapse7" aria-expanded="false" aria-controls="collapseExample" onclick="openCity(event, '7')">
                        7. How To Manage Applications
                    </button>
                    <div class="collapse child-0 card-0" id="Collapse7">

                            <!-- 71 -->
                            <button class=" child-0" onclick="window.location.href='#71';" type="button" >
                                7.1 Overview
                            </button>

                            <!-- 72 -->
                            <button class=" child-0" type="button" onclick="window.location.href='#72';" data-bs-toggle="collapse" data-bs-target="#collapseExample72" aria-expanded="false" aria-controls="collapseExample">
                                7.2 Create Application Flow
                            </button>
                            <div class="collapse child-1 card-0" id="collapseExample72">
                                <a class="" type="button" href="#721">
                                    7.2.1 Package Name 
                                </a>
                                <a class="" type="button" href="#722">
                                    7.2.2 Application Name
                                </a>
                                <a class="" type="button" href="#723">
                                    7.2.3 Description
                                </a>
                                <a class="" type="button" href="#724">
                            ...
                            <!-- 73 -->
                            <button class=" child-0" type="button" onclick="window.location.href='#73';">
                                7.3 Edit Application Flow
                            </button>


                            <!-- 74 -->
                            <button class=" child-0" type="button" onclick="window.location.href='#74';" data-bs-toggle="collapse" data-bs-target="#collapseExample74" aria-expanded="false" aria-controls="collapseExample">
                                7.4 Delete Application Options
                            </button>
                            <div class="collapse child-1 card-0" id="collapseExample74">
                                <a class="" type="button" href="#741">
                                    7.4.1 Delete Application
                                </a>
                                <a class="" type="button" href="#742">
                                    7.4.2 Delete Application Selected
                                </a>
                                <a class="" type="button" href="#743">
                            ...
                            <!-- 75 -->
                            <button class=" child-0" type="button" onclick="window.location.href='#75';" data-bs-toggle="collapse" data-bs-target="#collapseExample75" aria-expanded="false" aria-controls="collapseExample">
                                7.5 How To Create Device
                            </button>
                            <div class="collapse child-1 card-0" id="collapseExample75">
                                <a class="" type="button" href="#751">
                                    7.5.1 Overview
                                </a>
                                
                                <!-- 752 -->
                                <button class="child-1" type="button" onclick="window.location.href='#752';" data-bs-toggle="collapse" data-bs-target="#collapseExample752" aria-expanded="false" aria-controls="collapseExample">
                                    7.5.2 Create Device Flow
                                </button>
                                <div class="collapse child-2 card-0" id="collapseExample752">
                                    
                                    <!-- 7521 -->
                                    <a class="" type="button" onclick="window.location.href='#7521';" data-bs-toggle="collapse" data-bs-target="#collapseExample7521" aria-expanded="false" aria-controls="collapseExample">
                                        Number Of Devices
                                    </a>
                                    <div class="collapse child-2 card-0" id="collapseExample7521">


                                        <!-- 75211 -->
                                        <a class="" type="button" onclick="window.location.href='#75211';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211" aria-expanded="false" aria-controls="collapseExample">
                                            Single Device
                                        </a>
                                        <div class="collapse child-2 card-0" id="collapseExample75211">
                                            <a class="" type="button" onclick="window.location.href='#752111';" data-bs-toggle="collapse" data-bs-target="#collapseExample752111" aria-expanded="false" aria-controls="collapseExample">
                                                Product
                                            </a>
                                            <div class="collapse child-2 card-0" id="collapseExample752111">
                                                <a class="" type="button" onclick="window.location.href='#7521111';" data-bs-toggle="collapse" data-bs-target="#collapseExample7521111" aria-expanded="false" aria-controls="collapseExample">
                                                    Create Existing Product Flow
                                                </a>
                                                <div class="collapse child-2 card-0" id="collapseExample7521111">
                                                    <a class="" type="button" href="#75211111">
                                                        Choose Product Name
                                                    </a>
                                                    <a class="" type="button" href="#75211112">
                                                        Device Name
                                                    </a>
                                                    <a class="" type="button" onclick="window.location.href='#75211113';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211113" aria-expanded="false" aria-controls="collapseExample">
                                                        Choose Connectivity
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75211113">
                                                        <a class="" type="button" href="#752111131">
                                                            LoRa Connectivity
                                                        </a>
                                                        <a class="" type="button" href="#752111132">
                                                            MQTT Connectivity
                                                        </a>
                                                        <a class="" type="button" href="#752111131">
                                                            HTTP Connectivity
                                                    ...
                                                    <!-- 75211114 -->
                                                    <a class="" type="button" onclick="window.location.href='#75211114';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211114" aria-expanded="false" aria-controls="collapseExample">
                                                        LoRa Device Class
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75211114">
                                                        <a class="" type="button" href="#752111141">
                                                            Class A
                                                        </a>
                                                        <a class="" type="button" href="#752111142">
                                                            Class B
                                                        </a>
                                                        <a class="" type="button" href="#752111143">
                                                            Class C
                                                        </a>
                                                    </div>
                                                    ...
                                                    <!-- 75211115 -->
                                                    <a class="" type="button"onclick="window.location.href='#75211115';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211115" aria-expanded="false" aria-controls="collapseExample">
                                                        LoRa Activation Mode
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75211115">
                                                        <a class="" type="button" href="#752111151">
                                                            OTAA
                                                        </a>
                                                        <a class="" type="button" href="#752111152">
                                                            ABP
                                                        </a>
                                                    </div>
                                                    ...
                                                    <!-- 75211116 -->
                                                    <a class="" type="button"onclick="window.location.href='#75211116';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211116" aria-expanded="false" aria-controls="collapseExample">
                                                        OTAA Parameter
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75211116">
                                                        <a class="" type="button" href="#752111161">
                                                            Inherit
                                                        </a>
                                                        <a class="" type="button" href="#752111162">
                                                            Custom
                                                        </a>
                                                        <a class="" type="button" href="#752111163">
                                                            Application EUI
                                                        </a>
                                                        <a class="" type="button" href="#752111164">
                                                            Device EUI
                                                        </a>
                                                        <a class="" type="button" href="#752111165">
                                                            Application Key
                                                        </a>
                                                    </div>
                                                    ...
                                                    <!-- 75211117 -->
                                                    <a class="" type="button"onclick="window.location.href='#75211117';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211117" aria-expanded="false" aria-controls="collapseExample">
                                                        ABP Parameter
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75211117">
                                                        <a class="" type="button" href="#752111171">
                                                            Inherit
                                                        </a>
                                                        <a class="" type="button" href="#752111172">
                                                            Custom
                                                        </a>
                                                        <a class="" type="button" href="#752111173">
                                                            Application EUI
                                                        </a>
                                                        <a class="" type="button" href="#752111174">
                                                            Device EUI
                                                        </a>
                                                        <a class="" type="button" href="#752111175">
                                                            Device Address
                                                        </a>
                                                        <a class="" type="button" href="#752111176">
                                                            Network Session Key
                                                        </a>
                                                        <a class="" type="button" href="#752111177">
                                                            Application Session Key
                                                        </a>
                                                    </div>
                                                </div>

                                                <a class="" type="button" onclick="window.location.href='#7521112';" data-bs-toggle="collapse" data-bs-target="#collapseExample7521112" aria-expanded="false" aria-controls="collapseExample">
                                                    Create Custom Product Flow
                                                </a>
                                                <div class="collapse child-2 card-0" id="collapseExample7521112">

                                                    <a class="" type="button" href="#75211121" onclick="window.location.href='#75211121';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211121" aria-expanded="false" aria-controls="collapseExample">
                                                        Decoder
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75211121">


                                                        <a class="" type="button"onclick="window.location.href='#752111211';" data-bs-toggle="collapse" data-bs-target="#collapseExample752111211" aria-expanded="false" aria-controls="collapseExample">
                                                            New Decoder
                                                        </a>
                                                        <div class="collapse child-2 card-0" id="collapseExample752111211">
                                                            <a class="" type="button" href="#752111211a">
                                                                Decoder Name
                                                            </a>
                                                            <a class="" type="button" href="#752111211b">
                                                                Decoder Algorithm
                                                            </a>
                                                            <a class="" type="button" href="#752111211c">
                                                                Device Name
                                                            </a>
                                                        </div>

                                                        <a class="" type="button"onclick="window.location.href='#752111212';" data-bs-toggle="collapse" data-bs-target="#collapseExample752111212" aria-expanded="false" aria-controls="collapseExample">
                                                            Existing Decoder
                                                        </a>
                                                        <div class="collapse child-2 card-0" id="collapseExample752111212">
                                                            <a class="" type="button" href="#752111212a">
                                                                Decoder Name
                                                            </a>
                                                            <a class="" type="button" href="#752111212b">
                                                                Device Name
                                                            </a>
                                                        </div>

                                                        <a class="" type="button"onclick="window.location.href='#752111213';" data-bs-toggle="collapse" data-bs-target="#collapseExample752111213" aria-expanded="false" aria-controls="collapseExample">
                                                            No Decoder
                                                        </a>
                                                        <div class="collapse child-2 card-0" id="collapseExample752111213">
                                                            <a class="" type="button" href="#752111213a">
                                                                Device Name
                                                            </a>
                                                        </div>
                                                    ...
                                                    <a class="" type="button" onclick="window.location.href='#75211122';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211122" aria-expanded="false" aria-controls="collapseExample">
                                                        Choose Connectivity
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75211122">
                                                        <a class="" type="button" href="#752111221">
                                                            LoRa Connectivity
                                                        </a>
                                                        <a class="" type="button" href="#752111222">
                                                            MQTT Connectivity
                                                        </a>
                                                        <a class="" type="button" href="#752111223">
                                                            HTTP Connectivity
                                                        </a>
                                                    </div>


                                                    <a class="" type="button" onclick="window.location.href='#75211123';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211123" aria-expanded="false" aria-controls="collapseExample">
                                                        LoRa Device Class
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75211123">
                                                        <a class="" type="button" href="#752111231">
                                                            Class A
                                                        </a>
                                                        <a class="" type="button" href="#752111232">
                                                            Class B
                                                        </a>
                                                        <a class="" type="button" href="#752111233">
                                                            Class C
                                                        </a>
                                                    </div>


                                                    <a class="" type="button" onclick="window.location.href='#75211124';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211124" aria-expanded="false" aria-controls="collapseExample">
                                                        LoRa Activation Mode
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75211124">
                                                        <a class="" type="button" href="#752111241">
                                                            OTAA
                                                        </a>
                                                        <a class="" type="button" href="#752111242">
                                                            ABP
                                                        </a>
                                                    </div>
                                                    ...
                                                    <a class="" type="button" onclick="window.location.href='#75211125';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211125" aria-expanded="false" aria-controls="collapseExample">
                                                        OTAA Parameter
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75211125">
                                                        <a class="" type="button" href="#752111251">
                                                            Inherit
                                                        </a>
                                                        <a class="" type="button" href="#752111252">
                                                            Custom
                                                        </a>
                                                        <a class="" type="button" href="#752111253">
                                                            Application EUI
                                                        </a>
                                                        <a class="" type="button" href="#752111254">
                                                            Device EUI
                                                        </a>
                                                        <a class="" type="button" href="#752111255">
                                                            Application Key
                                                        </a>
                                                    </div>
                                                    ...
                                                    <a class="" type="button" onclick="window.location.href='#75211126';" data-bs-toggle="collapse" data-bs-target="#collapseExample75211126" aria-expanded="false" aria-controls="collapseExample">
                                                        OTAA Parameter
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75211126">
                                                        <a class="" type="button" href="#752111261">
                                                            Inherit
                                                        </a>
                                                        <a class="" type="button" href="#752111262">
                                                            Custom
                                                        </a>
                                                        <a class="" type="button" href="#752111263">
                                                            Application EUI
                                                        </a>
                                                        <a class="" type="button" href="#752111264">
                                                            Device EUI
                                                        </a>
                                                        <a class="" type="button" href="#752111265">
                                                            Device Address
                                                        </a>
                                                        <a class="" type="button" href="#752111266">
                                                            Network Session Key
                                                        </a>
                                                        <a class="" type="button" href="#752111267">
                                                            Application Session Key
                                                        </a>
                                                    </div>
                                        ...
                                        <a class="" type="button" onclick="window.location.href='#75212';" data-bs-toggle="collapse" data-bs-target="#collapseExample75212" aria-expanded="false" aria-controls="collapseExample">
                                            Multiple Device
                                        </a>
                                        <div class="collapse child-2 card-0" id="collapseExample75212">
                                            <a class="" type="button" href="#752121" onclick="window.location.href='#752121';" data-bs-toggle="collapse" data-bs-target="#collapseExample752121" aria-expanded="false" aria-controls="collapseExample">
                                                Product
                                            </a>
                                            <div class="collapse child-2 card-0" id="collapseExample752121">
                                                <a class="" type="button" onclick="window.location.href='#7521211';" data-bs-toggle="collapse" data-bs-target="#collapseExample7521211" aria-expanded="false" aria-controls="collapseExample">
                                                    Create Existing Product Flow
                                                </a>
                                                <div class="collapse child-2 card-0" id="collapseExample7521211">
                                                    <a class="" type="button" href="#75212111">
                                                        Choose Product Name
                                                    </a>
                                                    <a class="" type="button" onclick="window.location.href='#75212112';" data-bs-toggle="collapse" data-bs-target="#collapseExample75212112" aria-expanded="false" aria-controls="collapseExample">
                                                        Choose Connectivity
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75212112">
                                                        <a class="" type="button" href="#752121121">
                                                            LoRa Connectivity
                                                        </a>
                                                        <a class="" type="button" href="#752121122">
                                                            MQTT Connectivity
                                                        </a>
                                                        <a class="" type="button" href="#752121123">
                                                            HTTP Connectivity
                                                        </a>
                                                    </div>
                                                    <a class="" type="button" href="#75212113">
                                                        Upload File
                                                    </a>
                                                </div>
                                                ...
                                                <a class="" type="button" onclick="window.location.href='#7521212';" data-bs-toggle="collapse" data-bs-target="#collapseExample7521212" aria-expanded="false" aria-controls="collapseExample">
                                                    Create Custom Product Flow
                                                </a>
                                                <div class="collapse child-2 card-0" id="collapseExample7521212">

                                                    <a class="" type="button" onclick="window.location.href='#75212121';" data-bs-toggle="collapse" data-bs-target="#collapseExample75212121" aria-expanded="false" aria-controls="collapseExample">
                                                        Decoder
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75212121">
                                                        <a class="" type="button" onclick="window.location.href='#752121211';" data-bs-toggle="collapse" data-bs-target="#collapseExample752121211" aria-expanded="false" aria-controls="collapseExample">
                                                            New Decoder
                                                        </a>
                                                        <div class="collapse child-2 card-0" id="collapseExample752121211">
                                                            <a class="" type="button" href="#752121211a">
                                                                Decoder Name
                                                            </a>
                                                            <a class="" type="button" href="#752121211b">
                                                                Decoder Algorithm
                                                            </a>
                                                        </div>


                                                        <a class="" type="button" onclick="window.location.href='#752121212';" data-bs-toggle="collapse" data-bs-target="#collapseExample752121212" aria-expanded="false" aria-controls="collapseExample">
                                                            Existing Decoder
                                                        </a>
                                                        <div class="collapse child-2 card-0" id="collapseExample752121212">
                                                            <a class="" type="button" href="#752121212a">
                                                                Decoder Name
                                                            </a>
                                                        </div>


                                                        <a class="" type="button" href="#752121213">
                                                            No Decoder
                                                        </a>
                                                    </div>
                                                    ...
                                                    <a class="" type="button" onclick="window.location.href='#75212122';" data-bs-toggle="collapse" data-bs-target="#collapseExample75212122" aria-expanded="false" aria-controls="collapseExample">
                                                        Choose Connectivity
                                                    </a>
                                                    <div class="collapse child-2 card-0" id="collapseExample75212122">
                                                        <a class="" type="button" href="#752121221">
                                                            LoRa Connectivity
                                                        </a>
                                                        <a class="" type="button" href="#752121222">
                                                            MQTT Connectivity
                                                        </a>
                                                        <a class="" type="button" href="#752121223">
                                                            HTTP Connectivity
                                                        </a>
                                                    </div>


                                                    <a class="" type="button" href="#75212123">
                                                        Upload File
                                                    </a>
                                ...
                                <!-- 753 -->
                                <button class="child-1" type="button" onclick="window.location.href='#753';" data-bs-toggle="collapse" data-bs-target="#collapseExample753" aria-expanded="false" aria-controls="collapseExample">
                                    7.5.3 Manage Device Flow
                                </button>
                                <div class="collapse child-2 card-0" id="collapseExample753">
                                    <a class="" type="button" href="#7531">
                                        Choose Button Edit 
                                    </a>
                                    <a class="" type="button" href="#7532">
                                        Choose Button Delete
                                    </a>
                                    <a class="" type="button" href="#7533">
                                        Choose Button Move
                                    </a>
                                </div>
                            </div>
                    ...
                    <button class="" type="button" data-bs-toggle="collapse" data-bs-target="#Collapse8" aria-expanded="false" aria-controls="collapseExample" onclick="openCity(event, '8')">
                        8. Access Key Flow
                    </button>
                    <div class="collapse child-0 card-0" id="Collapse8">
                        <a class="" type="button" href="#81">
                            8.1 Create Access Key
                        </a>
                        <a class="" type="button" href="#82">
                            8.2 Access Key List
                        </a>
                        <a class="" type="button" href="#83">
                            8.3 Edit Access Key
                        </a>
                        <a class="" type="button" href="#84">
                            8.4 Delete Access Key
                        </a>
                        <a class="" type="button" href="#85">
                            8.5 Search Access Key
                        </a>
                    </div>


                    <button class="" type="button" data-bs-toggle="collapse" data-bs-target="#Collapse9" aria-expanded="false" aria-controls="collapseExample" onclick="openCity(event, '9')">
                        9. How to Send Data to Telkom IoT Platform
                    </button>
                    <div class="collapse child-0 card-0" id="Collapse9">
                        <a class="" type="button" href="#91">
                            9.1 Overview
                        </a>


                        <a class="" type="button" onclick="window.location.href='#92';" data-bs-toggle="collapse" data-bs-target="#collapseExample92" aria-expanded="false" aria-controls="collapseExample">
                            9.2 Integration using MQTT
                        </a>
                        <div class="collapse child-0 card-0" id="collapseExample92">
                            <a class="" type="button" href="#921">
                                9.2.1 Publish Data to IoT Platform using Node Red
                            </a>

                            <a class="" type="button" onclick="window.location.href='#922';" data-bs-toggle="collapse" data-bs-target="#collapseExample922" aria-expanded="false" aria-controls="collapseExample">
                                9.2.2 Subscribe Data to Telkom IoT Platform using Node Red
                            </a>
                            <div class="collapse child-0 card-0" id="collapseExample922">
                                <a class="" type="button" href="#9221">
                        ...
                        <a class="" type="button" href="#93">
                            9.3 Integration using LoRa
                        </a>

                        <a class="" type="button" onclick="window.location.href='#94';" data-bs-toggle="collapse" data-bs-target="#collapseExample94" aria-expanded="false" aria-controls="collapseExample">
                            9.4 Integration using HTTP
                        </a>
                        <div class="collapse child-0 card-0" id="collapseExample94">
                            <a class="" type="button" href="#941">
                ...
                <div id="1" class="tabcontent">
                    <div class="col-12 align-content-center justify-content-center align-items-center">
                        ...
                        <div class="row justify-content-between mt-4 mb-4">
                            ...
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '2')">
                                    <div class="col justify-content-start">
                                        <div class="body-3 text-PrimaryGreyColor text-left">Next</div>
                                        <div class="body-1 text-PrimaryLightColor">What is the benefit of Telkom IoT Platform?  <i class="bi bi-arrow-right"></i>  </div>
                                    </div>
                                </button>
                            </div>
                        </div>
                ...
                <div id="2" class="tabcontent">
                    <div class="col-12 align-content-center justify-content-center align-items-center">
                        ...
                        <div class="row justify-content-between mt-4 mb-4">
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '1')">
                                    <div class="col justify-content-end">
                                        <div class="body-3 text-PrimaryGreyColor text-right">Previous</div>
                                        <div class="body-1 text-PrimaryLightColor"> <i class="bi bi-arrow-left"></i>What is Telkom IoT Platform?   </div>
                                    </div>
                                </button>
                            </div>
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '3')">
                                    <div class="col justify-content-start">
                                        <div class="body-3 text-PrimaryGreyColor text-left">Next</div>
                                        <div class="body-1 text-PrimaryLightColor">Architecture of IoT Platform <i class="bi bi-arrow-right"></i>  </div>
                                    </div>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-between mt-4 mb-4">
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '2')">
                                    <div class="col justify-content-end">
                                        <div class="body-3 text-PrimaryGreyColor text-right">Previous</div>
                                        <div class="body-1 text-PrimaryLightColor"> <i class="bi bi-arrow-left"></i>What is the Benefit of Telkom IoT Platform?   </div>
                                    </div>
                                </button>
                            </div>
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '4')">
                                    <div class="col justify-content-start">
                                        <div class="body-3 text-PrimaryGreyColor text-left">Next</div>
                                        <div class="body-1 text-PrimaryLightColor">How To Register Your Account <i class="bi bi-arrow-right"></i>  </div>
                                    </div>
                                </button>
                            </div>
                        </div>
                ...
                <div id="4" class="tabcontent">
                    <div class="col-12 align-content-center justify-content-center align-items-center">
                        ...
                        <section id="411" class="align-items-center justify-content-center child-0">
                        ...
                        <section id="412" class="align-items-center justify-content-center child-0">
                        ...
                        <div class="row justify-content-between mt-4 mb-4">
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '3')">
                                    <div class="col justify-content-end">
                                        <div class="body-3 text-PrimaryGreyColor text-right">Previous</div>
                                        <div class="body-1 text-PrimaryLightColor"> <i class="bi bi-arrow-left"></i>Architecture of Telkom IoT Platform</div>
                                    </div>
                                </button>
                            </div>
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '5')">
                                    <div class="col justify-content-start">
                                        <div class="body-3 text-PrimaryGreyColor text-left">Next</div>
                                        <div class="body-1 text-PrimaryLightColor">Sign In <i class="bi bi-arrow-right"></i>  </div>
                                    </div>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '4')">
                                    <div class="col justify-content-end">
                                        <div class="body-3 text-PrimaryGreyColor text-right">Previous</div>
                                        <div class="body-1 text-PrimaryLightColor"> <i class="bi bi-arrow-left"></i>How To Register Your Account</div>
                                    </div>
                                </button>
                            </div>
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '6')">
                                    <div class="col justify-content-start">
                                        <div class="body-3 text-PrimaryGreyColor text-left">Next</div>
                                        <div class="body-1 text-PrimaryLightColor">Account Dashboard <i class="bi bi-arrow-right"></i>  </div>
                                    </div>
                                </button>
                            </div>
                    </div>
                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '5')">
                                    <div class="col justify-content-end">
                                        <div class="body-3 text-PrimaryGreyColor text-right">Previous</div>
                                        <div class="body-1 text-PrimaryLightColor"> <i class="bi bi-arrow-left"></i>Sign In</div>
                                    </div>
                                </button>
                            </div>
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '7')">
                                    <div class="col justify-content-start">
                                        <div class="body-3 text-PrimaryGreyColor text-left">Next</div>
                                        <div class="body-1 text-PrimaryLightColor">How To Manage Application<i class="bi bi-arrow-right"></i>  </div>
                                    </div>
                                </button>
                            </div>
                    </div>
                        ...
                        <section id="75">
                            ...
                            <section id="752" class="child-0">
                                ...
                                <section id="7521" class="child-1">
                                    ...
                                    <section id="75211" class="child-2">
                                        ...
                                        <section id="752111" class="child-3">
                                            ...
                                            <section id="7521111" class="child-4">
                                                ...
                                                <section id="75211111" class="child-5">
                                                ...
                                                <section id="75211112" class="child-5">
                                                ...
                                                <section id="75211113" class="child-5">
                                                    ...
                                                    <section id="752111131" class="child-6">
                                                    ...
                                                    <section id="752111132" class="child-6">
                                                    ...
                                                    <section id="752111133" class="child-6">
                                                ...
                                                <section id="75211114" class="child-5">
                                                    ...
                                                    <section id="752111141" class="child-6">
                                                    ...
                                                    <section id="752111142" class="child-6">
                                                    ...
                                                    <section id="752111143" class="child-6">
                                                ...
                                                <section id="75211115" class="child-5">
                                                    ...
                                                    <section id="752111151" class="child-6">
                                                    ...
                                                    <section id="752111152" class="child-6">
                                                ...
                                                <section id="75211116" class="child-5">
                                                    ...
                                                    <section id="752111161" class="child-6">
                                                    ...
                                                    <section id="752111162" class="child-6">
                                                    ...
                                                    <section id="752111163" class="child-6">
                                                    ...
                                                    <section id="752111164" class="child-6">
                                                    ...
                                                    <section id="752111165" class="child-6">
                                                ...
                                                <section id="75211117" class="child-5">
                                                    ...
                                                    <section id="752111171" class="child-6">
                                                        <h4 class="text-PrimaryColor">Inherit</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>make sure the data generated by the system and input into the end device.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111172" class="child-6">
                                                        <h4 class="text-PrimaryColor">Custom</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Input end device parameters into the system.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111173" class="child-6">
                                                        <h4 class="text-PrimaryColor">Application EUI</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Application EUI is a unique ID of the application server, obtained from the IEEE EUI64 standard that identifies the entity to connect to the network, Application EUI is stored on the end-device. Each application server will have a unique Application EUI ID. Application EUI can be generated by the Telkom IoT Platform, commonly called inherit or can also use the manual method, namely custom.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111174" class="child-6">
                                                        <h4 class="text-PrimaryColor">Device EUI</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Device EUI is like a Mac Address, or a unique code of the end device that follows the Lora alliance standard and is used to identify the device.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111175" class="child-6">
                                                    ...
                                                    <section id="752111176" class="child-6">
                                                    ...
                                                    <section id="752111177" class="child-6">
                                            ...
                                            <section id="7521112" class="child-4">
                                                ...
                                                <section id="75211121" class="child-5">
                                                    <h4 class="text-PrimaryColor">Decoder</h4>
                                                </section>
                                                
                                                    <section id="752111211" class="child-6">
                                                        ...
                                                        <section id="752111211a" class="child-7">
                                                        ...
                                                        <section id="752111211b" class="child-7">
                                                        ...
                                                        <section id="752111211c" class="child-7">
                                                    ...
                                                    <section id="752111212" class="child-6">
                                                        ...
                                                        <section id="752111212a" class="child-7">
                                                            <h4 class="text-PrimaryColor">a. Decoder Name</h4>
                                                            <div class="row align-items-center justify-content-center">
                                                                <p>The name of the decoder, is the name of the decoder that will be used and is defined by the user.</p>
                                                            </div>
                                                        ...
                                                        <section id="752111212b" class="child-7">
                                                    ...
                                                    <section id="752111213" class="child-6">
                                                        ...
                                                        <section id="752111213a" class="child-7">
                                                ...
                                                <section id="75211122" class="child-5">
                                                    <h4 class="text-PrimaryColor">Choose Connectivity</h4>
                                                    <div class="row align-items-center justify-content-center">
                                                        <p>Connectivity, the type of connectivity will be used for a device. User can choose the type of connectivity such as LoRa, MQTT, and HTTP. If user’s device use the LoRa connectivity parameter, the configuration is as follows:</p>
                                                    </div>
                                                    ...
                                                    <section id="752111221" class="child-6">
                                                        <h4 class="text-PrimaryColor">LoRa Connectivity</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>LoRa (Long Range) is a low-power long range wireless radio frequency technology.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111222" class="child-6">
                                                        <h4 class="text-PrimaryColor">MQTT Connectivity</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>MQTT, if your device uses MQTT, user can select MQTT connectivity then click the Save button. MQTT is a communication protocol that requires small resources and bandwidth. MQTT uses a broker in charge of connecting publishers and subscribers.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111223" class="child-6">
                                                        <h4 class="text-PrimaryColor">HTTP Connectivity</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>HTTP, if your device uses HTTP, user can select HTTP connectivity and then click the Save button. HTTP is an application layer network protocol that is used to assist the process of exchanging data on the internet between computers with one another.</p>
                                                        </div>
                                                ...
                                                <section id="75211123" class="child-5">
                                                    <h4 class="text-PrimaryColor">LoRa Device Class</h4>
                                                    <div class="row align-items-center justify-content-center">
                                                        <p>The lora network consists of end devices and gateways and is divided into three classes with definitions as class A, class B, and class C which are two-way communication.</p>
                                                    </div>
                                                    ...
                                                    <section id="752111231" class="child-6">
                                                        <h4 class="text-PrimaryColor">Class A</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>two-way communication with each device to send data, followed by two downlinks receiving short windows. Transition slots are scheduled by device and have the lowest power consumption.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111232" class="child-6">
                                                        <h4 class="text-PrimaryColor">Class B</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>two-way communication with scheduled slots receive, class B opens more receive windows. Thus allowing the device to synchronize the time from the gateway and notify the server when the device is operating.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111233" class="child-6">
                                                        <h4 class="text-PrimaryColor">Class C</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>two-way communication devices receive a maximum slot and almost have a slot receive window that opens and closes continuously when transmitting data, thus consuming more power, so it has the advantage of being able to communicate in real time.</p>
                                                        </div>
                                                ...
                                                <section id="75211124" class="child-5">
                                                    <h4 class="text-PrimaryColor">LoRa Activation Mode</h4>
                                                    <div class="row align-items-center justify-content-center">
                                                    ...
                                                    <section id="752111241" class="child-6">
                                                        <h4 class="text-PrimaryColor">OTAA</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Over-the-air activation, which involves direct communication between server and end device.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111242" class="child-6">
                                                        <h4 class="text-PrimaryColor">ABP</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Involving new end devices which were added without existing keys, such as AppEUI, devEUI, etc.</p>
                                                        </div>
                                                ...
                                                <section id="75211125" class="child-5">
                                                    <h4 class="text-PrimaryColor">OTAA Parameter</h4>
                                                    <div class="row align-items-center justify-content-center">
                                                        <p>There are 2 options in it, including the following:</p>
                                                    </div>
                                                    ...
                                                    <section id="752111251" class="child-6">
                                                        <h4 class="text-PrimaryColor">Inherit</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                    ...
                                                    <section id="752111252" class="child-6">
                                                        <h4 class="text-PrimaryColor">Custom</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                    ...
                                                    <section id="752111253" class="child-6">
                                                        <h4 class="text-PrimaryColor">Application EUI</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Application EUI is a unique ID of the application server, obtained from the IEEE EUI64 standard that identifies the entity to connect to the network, Application EUI is stored on the end-device. Each application server will have a unique Application EUI ID. Application EUI can be generated by the Telkom IoT Platform, commonly called inherit or can also use the manual method, namely custom.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111254" class="child-6">
                                                        <h4 class="text-PrimaryColor">Device EUI</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Device EUI is like a Mac Address, or a unique code of the end device that follows the Lora alliance standard and is used to identify the device.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111255" class="child-6">
                                                        <h4 class="text-PrimaryColor">Application Key</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>The Application Key is the encryption key between the message source behind the Device EUI and the message destination behind the Application EUI. Each key must be unique for each device.</p>
                                                        </div>
                                                ...
                                                <section id="75211126" class="child-5">
                                                    <h4 class="text-PrimaryColor">ABP Parameter</h4>
                                                    <div class="row align-items-center justify-content-center">
                                                        <p>There are 2 options in it, including the following:</p>
                                                    </div>
                                                    ...
                                                    <section id="752111261" class="child-6">
                                                        <h4 class="text-PrimaryColor">Inherit</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Make sure the data generated by the system and input into the end device. Then press the send button.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111262" class="child-6">
                                                        <h4 class="text-PrimaryColor">Custom</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                    ...
                                                    <section id="752111263" class="child-6">
                                                        <h4 class="text-PrimaryColor">Application EUI</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Application EUI is a unique ID of the application server, obtained from the IEEE EUI64 standard that identifies the entity to connect to the network, Application EUI is stored on the end-device. Each application server will have a unique Application EUI ID. Application EUI can be generated by the Telkom IoT Platform, commonly called inherit or can also use the manual method, namely custom.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111264" class="child-6">
                                                        <h4 class="text-PrimaryColor">Device EUI</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Device EUI is like a Mac Address, or a unique code of the end device that follows the Lora alliance standard and is used to identify the device.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111265" class="child-6">
                                                        <h4 class="text-PrimaryColor">Device Address</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Device Address serves to identify the hardware as an identifier so that each particular device has a unique ID.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111266" class="child-6">
                                                        <h4 class="text-PrimaryColor">Network Session Key</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Network Session Key (NwkSKey) is used for interaction between Node and Network Server which is used to validate integrity on each message with integrity code on each message.</p>
                                                        </div>
                                                    ...
                                                    <section id="752111267" class="child-6">
                                                        <h4 class="text-PrimaryColor">Application Session Key</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>Network Session Key (NwkSKey) is used for interaction between Node and Network Server which is used to validate integrity on each message with integrity code on each message.</p>
                                                        </div>
                                    ...
                                    <section id="75212" class="child-2">
                                        ...
                                        <section id="752121" class="child-3">
                                            <h4 class="text-PrimaryColor">Product</h4>
                                            <div class="row align-items-center justify-content-center">
                                                <p>Product, is the type of device that will determine the product to be made, including existing product and custom product:</p>
                                            </div>
                                            ...
                                            <section id="7521211" class="child-4">
                                                <h4 class="text-PrimaryColor">Create Existing Product Flow</h4>
                                                <div class="row align-items-center justify-content-center">
                                                ...
                                                <section id="75212111" class="child-5">
                                                    <h4 class="text-PrimaryColor">Choose Product Name</h4>
                                                    <div class="row align-items-center justify-content-center">
                                                ...
                                                <section id="75212112" class="child-5">
                                                    <h4 class="text-PrimaryColor">Choose Connectivity</h4>
                                                    <div class="row align-items-center justify-content-center">
                                                        <p>Connectivity, the type of connectivity will be used for a device. User can choose the type of connectivity such as LoRa, MQTT, and HTTP. If user’s device use the LoRa connectivity parameter, the configuration is as follows:</p>
                                                    </div>
                                                    ...
                                                    <section id="752121121" class="child-6">
                                                        <h4 class="text-PrimaryColor">LoRa Connectivity</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>LoRa (Long Range) is a low-power long range wireless radio frequency technology.</p>
                                                        </div>
                                                    ...
                                                    <section id="752121122" class="child-6">
                                                        <h4 class="text-PrimaryColor">MQTT Connectivity</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>MQTT, if your device uses MQTT, user can select MQTT connectivity then click the Save button. MQTT is a communication protocol that requires small resources and bandwidth. MQTT uses a broker in charge of connecting publishers and subscribers.</p>
                                                        </div>
                                                    ...
                                                    <section id="752121123" class="child-6">
                                                        <h4 class="text-PrimaryColor">HTTP Connectivity</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>HTTP, if your device uses HTTP, user can select HTTP connectivity and then click the Save button. HTTP is an application layer network protocol that is used to assist the process of exchanging data on the internet between computers with one another.</p>
                                                        </div>
                                                ...
                                                <section id="75212113" class="child-5">
                                            ...
                                            <section id="7521212" class="child-4">
                                                <h4 class="text-PrimaryColor">Create Custom Product Flow</h4>
                                                <div class="row align-items-center justify-content-center">
                                                    <p>Custom Product, field that contains user’s settings who have their own devices in the form of decoder.</p>
                                                </div>
                                                ...
                                                <section id="75212121" class="child-5">
                                                    <h4 class="text-PrimaryColor">Decoder</h4>
                                                </section>

                                                    <section id="752121211" class="child-6">
                                                        <h4 class="text-PrimaryColor">New Decoder</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>On the new decoder, the user can enter a new decoder that has never been created before. The following are additional data inputs that the user must enter:</p>
                                                        </div>
                                                        ...
                                                        <section id="752121211a" class="child-7">
                                                        ...
                                                        <section id="752121211b" class="child-7">
                                                    ...
                                                    <section id="752121212" class="child-6">
                                                        <h4 class="text-PrimaryColor">Existing Decoder</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>On the existing decoder, the user can choose a decoder that has been made previously on the existing decoder, the user can choose a decoder that has been made previously. Device name, is the name of the device which will be used and specified by the user. The following are additional data inputs that the user must enter:</p>
                                                        </div>
                                                        ...
                                                        <section id="752121212a" class="child-7">
                                                            <h4 class="text-PrimaryColor">Decoder Name</h4>
                                                            <div class="row align-items-center justify-content-center">
                                                                <p>The name of the decoder, is the name of the decoder that will be used and is defined by the user.</p>
                                                            </div>
                                                    ...
                                                    <section id="752121213" class="child-6">
                                                        <h4 class="text-PrimaryColor">No Decoder</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                ...
                                                <section id="75212122" class="child-5">
                                                    <h4 class="text-PrimaryColor">Choose Connectivity</h4>
                                                    <div class="row align-items-center justify-content-center">
                                                        <p>Connectivity, the type of connectivity will be used for a device. User can choose the type of connectivity such as LoRa, MQTT, and HTTP. If user’s device use the LoRa connectivity parameter, the configuration is as follows:</p>
                                                    </div>
                                                    ...
                                                    <section id="752121221" class="child-6">
                                                        <h4 class="text-PrimaryColor">LoRa Connectivity</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>LoRa (Long Range) is a low-power long range wireless radio frequency technology.</p>
                                                        </div>
                                                    ...
                                                    <section id="752121222" class="child-6">
                                                        <h4 class="text-PrimaryColor">MQTT Connectivity</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>MQTT, if your device uses MQTT, user can select MQTT connectivity then click the Save button. MQTT is a communication protocol that requires small resources and bandwidth. MQTT uses a broker in charge of connecting publishers and subscribers.</p>
                                                        </div>
                                                    ...
                                                    <section id="752121223" class="child-6">
                                                        <h4 class="text-PrimaryColor">HTTP Connectivity</h4>
                                                        <div class="row align-items-center justify-content-center">
                                                            <p>HTTP, if your device uses HTTP, user can select HTTP connectivity and then click the Save button. HTTP is an application layer network protocol that is used to assist the process of exchanging data on the internet between computers with one another.</p>
                                                        </div>
                                                ...
                                                <section id="75212123" class="child-5">
                                                    <h4 class="text-PrimaryColor">Upload File</h4>
                                                    <div class="row justify-content-center">
                        ...
                        <div class="row justify-content-between mt-4 mb-4">
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '6')">
                                    <div class="col justify-content-end">
                                        <div class="body-3 text-PrimaryGreyColor text-right">Previous</div>
                                        <div class="body-1 text-PrimaryLightColor"> <i class="bi bi-arrow-left"></i>Account Dashboard</div>
                                    </div>
                                </button>
                            </div>
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '8')">
                                    <div class="col justify-content-start">
                                        <div class="body-3 text-PrimaryGreyColor text-left">Next</div>
                                        <div class="body-1 text-PrimaryLightColor">Access Key Flow <i class="bi bi-arrow-right"></i>  </div>
                                    </div>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '7')">
                                    <div class="col justify-content-end">
                                        <div class="body-3 text-PrimaryGreyColor text-right">Previous</div>
                                        <div class="body-1 text-PrimaryLightColor"> <i class="bi bi-arrow-left"></i>How To Manage Applications</div>
                                    </div>
                                </button>
                            </div>
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '9')">
                                    <div class="col justify-content-start">
                                        <div class="body-3 text-PrimaryGreyColor text-left">Next</div>
                                        <div class="body-1 text-PrimaryLightColor">How To Send Data to Telkom IoT Platform<i class="bi bi-arrow-right"></i>  </div>
                                    </div>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-between mt-4 mb-4">
                            <div class="col-auto">
                                <button type="button" class="btn" onclick="openCity(event, '8')">
                                    <div class="col justify-content-end">
                                        <div class="body-3 text-PrimaryGreyColor text-right">Previous</div>
                                        <div class="body-1 text-PrimaryLightColor"> <i class="bi bi-arrow-left"></i>Access Key Flow</div>
                                    </div>
                                </button>
                            </div>
                            <div class="col-auto">
