        ...
        <section class="UsecaseHead padding48h fullwidth" style="margin-top: 0px;margin-bottom: 0px; z-index: 20;" >
            ...
            <div class="row padding32h fullheight justify-content-start align-items-center mb-4" >
                <div class="col-auto align-middle">
                    <h2 class="text-PrimaryColor">Smart City</h2>
                    <div class="containerText">
                        <p class="body-3">
                            As the name implies, Smart City, IoT technology is applied centrally to various aspects of urban life. With the IoT ecosystem, digitalization of devices that are used daily can be implemented easily, such as home and street lighting, household appliances, and other various types of devices
                        </p>
                    </div>
                </div>
            </div>
            <img src="{{route('file','assets/image/SmartControllerBG.webp')}}" class="image_usecaseHead" alt="">
        </section>
        ...
        <section style="margin-top: 64px; ">
            ...
            <div class="row p-5 g-3 mb-5">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <h3 class="text-PrimaryColor">Smart Public Street Lighting </h3>
                    <p class="body-3">
                        <b class="text-PrimaryLightColor">Smart Public Street Lighting</b> aligns with smart city implementation, intended to monitor and control street lightings using low cost, low power, and wide area IoT connectivity. Besides, this solution can also calculate the usage of electricity power of individual street lighting as well.
                    </p>
                                    ...
                                    <div class="row padding48h mt-4">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="Smart Public Street Lighting" disabled>
                                            </div>
                                            <div class="row">
                                                <div class="mb-3">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <img src="{{route('file','assets/image/Living Lab Journey_PJU_isometric no backgrd.webp')}}" class="imgLL" alt="">
                </div>
            </div>
        </section>
