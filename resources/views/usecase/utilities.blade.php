        ...
        <section class="UsecaseHead padding48h fullwidth" style="margin-top: 0px;margin-bottom: 0px; z-index: 20;" >
            ...
            <div class="row padding32h fullheight justify-content-start align-items-center mb-4" >
                <div class="col-auto align-middle">
                    <h2 class="text-PrimaryColor">Utilities</h2>
                    <div class="containerText">
                        <p class="body-3">
                            The application of IoT technology in the infrastructure sector that used by many people and managed by large companies such as electricity, water, and gas
                        </p>
                    </div>
                </div>
            </div>
            <img src="{{route('file','assets/image/utilities 1.png')}}" class="image_usecaseHead lazy" alt="">
        </section>
        ...
        <section style="margin-top: 64px; ">
            ...
            <div class="row p-5 g-3 mb-5">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <h3 class="text-PrimaryColor">Smart Metering</h3>
                    <p class="body-3">
                        The need for smart grid implementation is inevitable, therefore intelligent metering systems are under intense discussion to be implemented in these years. <b>Electricity, water, and gas meters need an automated metering infrastructure so that users can track their profitability and maintain excellent service as well.</b> Telkom IoT Platform along with LoRaWAN connectivity can support this use case with reliable and low-cost services.
                    </p>
                                    ...
                                    <div class="row padding48h mt-4">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="Smart Metering" disabled>   
                                            </div>
                                            <div class="row">
                                                <div class="mb-3">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <img src="{{route('file','assets/image/Living Lab Journey_smartmeter_isometric no backgrd.png')}}" class="imgLL" alt="">
                </div>
            </div>
        </section>
